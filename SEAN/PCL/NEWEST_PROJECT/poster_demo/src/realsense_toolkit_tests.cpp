...
void test_voxelFilter_leafSize(pcl::PointCloud<pcl::PointXYZ>::Ptr sourceCloud)
{
	...
	log_voxelFilter(sourceCloud, cloud_filtered, "../pictures/T02_voxel_01.pcd",
	                "voxel filter, 01:", 0.01);
	log_voxelFilter(sourceCloud, cloud_filtered, "../pictures/T02_voxel_02.pcd",
	                "voxel filter, 02:", 0.02);
	log_voxelFilter(sourceCloud, cloud_filtered, "../pictures/T02_voxel_03.pcd",
	                "voxel filter, 03:", 0.03);
	log_voxelFilter(sourceCloud, cloud_filtered, "../pictures/T02_voxel_04.pcd",
	                "voxel filter, 04:", 0.04);
	log_voxelFilter(sourceCloud, cloud_filtered, "../pictures/T02_voxel_05.pcd",
...
///////////////////////////////////////////////////////////////////////////////
/** 
 * desc:  This function returns statistics for the getPlane() function based
 *        on the number of ransac iterations. This test will return plane inliers 
 *        based on test_getPrism parameters.
 * param: (in) sourceCloud - ptr to point cloud 
 */
 void test_getPlane_iterations(pcl::PointCloud<pcl::PointXYZ>::Ptr sourceCloud)
 {
 	...
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeIterations_01.pcd", "plane Iterations, 01: ",
                  MIN_ANGLE, MAX_ANGLE, 200, 0.01);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeIterations_02.pcd", "plane Iterations, 02: ",
                  MIN_ANGLE, MAX_ANGLE, 400, 0.01);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeIterations_03.pcd", "plane Iterations, 03: ",
                  MIN_ANGLE, MAX_ANGLE, 600, 0.01);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeIterations_04.pcd", "plane Iterations, 04: ",
                  MIN_ANGLE, MAX_ANGLE, 800, 0.01);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeIterations_05.pcd", "plane Iterations, 05: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.01);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeIterations_06.pcd", "plane Iterations, 06: ",
                  MIN_ANGLE, MAX_ANGLE, 1200, 0.01);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeIterations_07.pcd", "plane Iterations, 07: ",
                  MIN_ANGLE, MAX_ANGLE, 1400, 0.01);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeIterations_08.pcd", "plane Iterations, 08: ",
                  MIN_ANGLE, MAX_ANGLE, 1600, 0.01);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeIterations_09.pcd", "plane Iterations, 09: ",
                  MIN_ANGLE, MAX_ANGLE, 1800, 0.01);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeIterations_10.pcd", "plane Iterations, 10: ",
                  MIN_ANGLE, MAX_ANGLE, 2000, 0.01);
 }


 ///////////////////////////////////////////////////////////////////////////////
/** 
 * desc:  This function returns statistics for the getPlane()function when the 
 *        threshold distance is altered. This test will return plane inliers 
 *        based on test_getPrism parameters.
 * param: (in) sourceCloud - ptr to point cloud 
 */
 void test_getPlane_threshold(pcl::PointCloud<pcl::PointXYZ>::Ptr sourceCloud)
 {
 	pcl::PointCloud<pcl::PointXYZ>::Ptr planeCloud (new pcl::PointCloud<pcl::PointXYZ>);
 	pcl::PointCloud<pcl::PointXYZ>::Ptr outliersCloud (new pcl::PointCloud<pcl::PointXYZ>);
 	pcl::ModelCoefficients::Ptr coefficients (new pcl::ModelCoefficients);
 	...
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeThreshold_01.pcd", "plane threshold, 01: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.01);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeThreshold_02.pcd", "plane threshold, 02: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.02);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeThreshold_03.pcd", "plane threshold, 03: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.03);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeThreshold_04.pcd", "plane threshold, 04: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.04);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeThreshold_05.pcd", "plane threshold, 05: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.05);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeThreshold_06.pcd", "plane threshold, 06: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.06);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeThreshold_07.pcd", "plane threshold, 07: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.07);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeThreshold_08.pcd", "plane threshold, 08: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.08);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeThreshold_09.pcd", "plane threshold, 09: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.09);
 	log_getPlane(sourceCloud, planeCloud, outliersCloud, coefficients, indices,	
                  "../pictures/T04_planeThreshold_10.pcd", "plane threshold, 10: ",
                  MIN_ANGLE, MAX_ANGLE, 1000, 0.10);
 }
...
///////////////////////////////////////////////////////////////////////////////
/**
 * desc: This function returns logging information from log_getClusters().
 * param: (in) sourceCloud - ptr to point cloud to be tested
 */
void test_getClusters(pcl::PointCloud<pcl::PointXYZ>::Ptr sourceCloud)
{
	log_getClusters(sourceCloud, "../pictures/T07_clusters_", 
	                "Euclidean Cluster: ", 0.02, 20, 1.0, MIN_ANGLE, MAX_ANGLE,
	                500, 0.01, 0.02, 0.2, 0.02, 10, 1000);
}
 ...
 *        (in) maxRadius - maximum radius between plane and camera in radians (ex. MAX_ANGLE)
...
/**
 * desc: This function takes a source PCD image an segments out objects found 
 *       on a plane. Objects are segmented using euclidean cluster extraction.
 * param: (in) sourceCloud - ptr to input cloud
 *        (in) pcdFileName - name and location of file (e.g ../foo/foo.pcd)
 *        (in) flavorText - text displayed after execution time
 *        (in) leafSize - size of voxel in cm^3. (ex. 0.01 = 1 cm)
 ...
 *        (in) minObjectDistance - lowest point of objects above a plane (ex 0.01 = 1cm)
 *        (in) maxObjectDistance - highest point of objects above a plane (ex 0.2 = 20cm)
 *        (in) clusterTolerance - accpeted distance between points in a cluster. (ex 0.02 = 2cm)
 *                                Too small of a value can result in 1 object 
 *                                being split into multiple clusters. Too large 
 *                                of a value can result in multiple objects being 
 *                                merged into a single cluster.
 *        (in) minClusterSize - minimum number of points in a cluster(ex 20)
 *        (in) maxClusterSize - maximum number of points in a cluster(ex 10000)
 * pre-cond: all output variables must be declared before function is called.
 */						
void log_getClusters(pcl::PointCloud<pcl::PointXYZ>::Ptr sourceCloud,
                     const std::string& pcdFileName, const std::string& flavorText,
                     float leafSize, int neighborsToAnalyze, double stdDeviation,
                     double minRadius, double maxRadius,
                     int ransacIterations, double thresholdDistance,
                     ...
                     int maxClusterSize)
{
	...
	std::vector<pcl::PointIndices> cluster_indices;  // holds vextor of all found clusters
	...
	// find objects on top of a plane 
	result = c44::segObjects(sourceCloud, objectsCloud, leafSize, neighborsToAnalyze, 
	                         stdDeviation, minRadius, maxRadius, ransacIterations, 
	                         thresholdDistance, minObjectDistance, maxObjectDistance);
