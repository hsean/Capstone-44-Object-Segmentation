...
int c44::getPlane(pcl::PointCloud<pcl::PointXYZ>::Ptr sourceCloud,  
                  ...
                  int ransacIterations, double thresholdDistance)
{
	// create objects to hold plane information
	...
	std::cout << "BEGINNING MANDATORY SECTION" << std::endl;
	// Mandatory
	...
	std::cout << "STARTING PLANE CHECK" << std::endl;
	// check if a plane was found	
	if (plane_indices->indices.size() == 0)
	{	// No plane was found
		return -1;
	}
	std::cout << "FINISHED PLANE CHECK" << std::endl;
	...
	std::cout << "SETTING INDICES" << std::endl;
	extract.setIndices(plane_indices);
	std::cout << "SET NEGATIVE FALSE" << std::endl;
	...
	// Create the filtering object
	std::cout << "SET NEGATIVE TRUE" << std::endl;
	extract.setNegative(true);
	std::cout << "GET OUTLIERS" << std::endl;
