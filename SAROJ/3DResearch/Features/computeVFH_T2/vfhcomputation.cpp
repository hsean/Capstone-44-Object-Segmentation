    ...
    //=====================================================================================//  
     ...
     //===============================================================================//
        ...
        // Create an empty kdtree representation, and pass it to the normal estimation object.
  		...
  		pcl::search::KdTree<pcl::PointXYZ>::Ptr gtree (new pcl::search::KdTree<pcl::PointXYZ> ());
  		gne.setSearchMethod (gtree);
  		// Use all neighbors in a sphere of radius 1cm
  		gne.setRadiusSearch (0.01);
  		// Compute the features
 		 gne.compute (*general_normals);

 		std::cerr << "PointCloud Size after Normal: " << general_normals->points.size ()<< ".\n";
