...
main (int argc, char *argv[])
{
  ...
  std::cout << "Computing KeyPoint Extraction" << std::endl;
  time_before_execution = boost::posix_time::microsec_clock::local_time();  // time before
  ...
  std::cout << "Computing KDTree" << std::endl;
  time_before_execution = boost::posix_time::microsec_clock::local_time();  // time before
  ...
  std::cout << "Computing Hough3D" << std::endl;
  time_before_execution = boost::posix_time::microsec_clock::local_time();  // time before
  //  Using Hough3D
  if (use_hough_)
  {
